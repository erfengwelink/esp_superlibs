...
static void prvvMasterTIMERExpiredISR( void );
...
static void init_timer_group_0( USHORT N50us )
{
    ...
    timer_isr_register(timer_group, timer_idx, (MB_DEVICE_USE_TYPE == MB_DEVICE_MASTER)? \
    prvvMasterTIMERExpiredISR : prvvTIMERExpiredISR, (void*) timer_idx, ESP_INTR_FLAG_LOWMED, NULL);
}
...
{
    USHORT timer_tick = 4000;
    init_timer_group_0( timer_tick );
    vMBPortTimersEnable(  );
}
